...
namespace Office_ToDLL.Funtion
{
    public class ExcelTo_Img
    {
        ...
        public static void ExcelToImg(string ExcelPath, string ImgOutPath, ImageFormat ImgType)
        {
            ...
            foreach (var item in list)
            {
                ...
                {
                    //设置图片输出地址和名称
                    string Outpath = $@"{ImgOutPath}{Path.GetFileNameWithoutExtension(ExcelPath)}-{item.Name}.{ImgType}";
                    //获取Excel转换的图片
